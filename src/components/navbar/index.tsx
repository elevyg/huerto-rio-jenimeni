...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div className="ml-6 flex items-center justify-between md:container md:mx-auto md:ml-0">
        ...
        <nav className="hidden md:block">
          <ul className="flex space-x-6">
            ...
            <li>
              <Link
                href="https://www.instagram.com/huertoriojeinimeni/"
                target="_blank"
              >
                <Instagram className="h-6 w-6 text-[#2c5545]" />
              </Link>
            </li>
          </ul>
        </nav>
